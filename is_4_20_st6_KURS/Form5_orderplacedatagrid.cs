...
{
    public partial class Form5_orderplacedatagrid : Form
    {
        ...
        public Form5_orderplacedatagrid()
        {
            InitializeComponent();
        }
        ...
        public void DeletePlace()
        {
            ...
            string sql_delete_place = "DELETE FROM OrderPlace WHERE id='" + id_selected_rows + "'";
            //Посылаем запрос на обновление данных
            MySqlCommand delete_user = new MySqlCommand(sql_delete_place, conn);
            try
            {
                conn.Open();
        ...
        public void ChangeStateOrder(string new_order)
        {
            ...
            string query2 = $"UPDATE OrderPlace SET id='{new_order}' WHERE (OrderM='{redact_id}')";
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT id AS 'Код', Afisha AS 'Название', place AS 'Место', " +
                "OrderM AS 'Бронь' FROM OrderPlace";
        ...
        private void Form3_afishadatagrid_Load(object sender, EventArgs e)
        {
        ...
        private void удалитьБроньToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ChangeStateOrder("1");
        }
