...
{
    public partial class Form3_afisha : MetroForm
    {
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT id_Afisha AS 'Код', title AS 'Название', duration AS 'Продолжительность', dt AS 'Дата' FROM Afisha";
        ...
        {
            string tmp = $"INSERT INTO Afisha (title, duration, dt) VALUES ('{metroTextBox1.Text}', '{metroTextBox2.Text}', '{metroDateTime1.Value.ToString("yyyy-MM-dd")}')";
        ...
        {
            string sql_delete = "DELETE FROM Afisha WHERE id_Afisha='" + id_selected_rows + "'";
